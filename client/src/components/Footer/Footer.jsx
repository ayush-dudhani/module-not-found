        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Pimpri Chinchwad, Maharashtra</p>
              <p className="office__info">Phone: +91 987654321</p>
              <p className="office__info">Email: rentwithus@gmail.com</p>
